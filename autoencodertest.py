...
def train_models(models, losses, optimizers, data_generator, validation_data_generator, epochs=10, steps_per_epoch=100, batch_size=128, use_checkpoints=False, ckpt_dir='saved_models_ckpt'):
